...
describe('Activities Store - Business Logic Tests', () => {
    const wrapper = ({ children }) => ((0, jsx_runtime_1.jsx)(activitiesStore_1.ActivitiesProvider, { children: children }));
    describe('Initialization', () => {
        test('initializes with default activities', () => {
            const { result } = (0, react_1.renderHook)(() => (0, activitiesStore_1.useActivities)(), { wrapper });
    ...
    describe('Data Persistence', () => {
        test('activities persist across re-renders', () => {
            const { result, rerender } = (0, react_1.renderHook)(() => (0, activitiesStore_1.useActivities)(), { wrapper });
            (0, react_1.act)(() => {
    ...
    describe('Context Provider Error Handling', () => {
        test('throws error when useActivities called outside provider', () => {
            ...
            expect(() => {
                (0, react_1.renderHook)(() => (0, activitiesStore_1.useActivities)());
    ...
    describe('Complex Workflows', () => {
        ...
        test('bulk operations maintain data integrity', () => {
            ...
            const completedActivities = result.current.activities.filter(a => idsToToggle.includes(a.id) && a.completed);
            ...
            const deletedStillPresent = result.current.activities.filter(a => idsToDelete.includes(a.id));
