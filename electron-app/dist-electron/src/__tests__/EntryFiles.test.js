...
describe('Entry Files - Smoke Tests', () => {
    ...
    test('App can be rendered multiple times', () => {
        const { container: container1 } = (0, react_1.render)((0, jsx_runtime_1.jsx)(App_1.default, {}));
        const { container: container2 } = (0, react_1.render)((0, jsx_runtime_1.jsx)(App_1.default, {}));
