...
describe("CommunicationScreen", () => {
  ...
  it("opens Edit modal, validates phone, and saves to context", () => {
    const setEmergencyContactData = jest.fn();
    ...
    fireEvent.changeText(
      screen.getByPlaceholderText("Enter 10-digit phone number"),
      "123",
    );
    ...
    expect(setEmergencyContactData).not.toHaveBeenCalled();
    ...
    expect(setEmergencyContactData).toHaveBeenCalledWith({
      name: "Mom",
      phone: "2025550101",
    });
  });

  it("Cancel closes modal (smoke)", () => {
    render(<CommunicationScreen />);
