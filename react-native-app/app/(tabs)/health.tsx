...
const NavItem = ({
  ...
  return (
    ...
    >
      <View style={styles.navIconWrap} accessible={false} importantForAccessibility="no">
        <Text
...
>
  <View style={styles.bottomNavRow} accessible={false} importantForAccessibility="no">
