...
>
  <View style={styles.navRow} accessible={false} importantForAccessibility="no">
    <Pressable
      ...
      hitSlop={10}
    >
      <Text style={{ color: highContrastMode ? "#fff" : "#6B7280", fontWeight: "800" }} accessible={false}>
        Home
      </Text>
    </Pressable>
    ...
    <Pressable
      ...
      hitSlop={10}
    >
      <Text style={{ color: highContrastMode ? colors.primary : colors.primary, fontWeight: "900" }} accessible={false}>
        Messages
      </Text>
    </Pressable>
